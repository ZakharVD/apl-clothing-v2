        ...
        <div className="absolute flex flex-col top-11 right-[-120px] sm:right-0 bg-white border-[1px] shadow-lg w-[100vw] sm:w-44 max-w-[400px] rounded-xl z-30">
          {currentUser !== null ? (
            ...
            <>
              <Link
                to={"/register"}
                className="text-center py-4 sm:py-1 px-2 mx-2 mt-2 mb-1 rounded-lg bg-black text-white cursor-pointer"
              >
                Sign Up
              </Link>
              <Link
                to={"/login"}
                className="text-center p-3 sm:py-[2px] mt-1 mb-2 mx-2 border-[1px] border-transparent hover:border-gray-300 rounded-lg cursor-pointer"
              >
                Login
              </Link>
            </>
